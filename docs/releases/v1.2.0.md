...
This release is validated with ESLint, TypeScript, Vitest, Cargo tests, strict Clippy, Prettier, production build checks, and signed macOS/Windows release packaging in GitHub Actions.
