...
This release is validated with ESLint, TypeScript, Vitest, Cargo tests, strict Clippy, Prettier, and production build checks. A tagged macOS release is additionally blocked unless its DMG passes Developer ID code-signing, Apple notarization, Gatekeeper and disk-image integrity validation.
